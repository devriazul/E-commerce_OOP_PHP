                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="#"><?php echo $resource_obj->name; ?></a>
                                        <div class="ratting">
                                    ...
                                    <div class="product-price" style="color:white;">
                                        <h5>
											$<del><?php echo $resource_obj->selling_price; ?></del>&nbsp;<span>$</span><?php echo $resource_obj->selling_price - ($resource_obj->selling_price * $resource_obj->discount)/100; ?> <?php echo " (-". $resource_obj->discount ."%)"; ?>
										</h5>
